...
export const moneyTransferAPI_v1 = {
  /* API tạo link */
  ...
  postSocialDonateMoneyLinkInformation(args) {
    return makeRequest(
      '/Social/DonateMoney/Link/Information',
      API_ENDPOINT,
      HTTP_METHOD.POST,
      args
    )
  ...
  postSocialRequestMoneyLinkInformation(args) {
    return makeRequest(
      '/Social/RequestMoney/Link/Information',
      API_ENDPOINT,
      HTTP_METHOD.POST,
      args
    )
  ...
  postSocialReceiveMoneyLinkInformation(args) {
    return makeRequest(
      '/Social/SendMoney/Link/Information',
      API_ENDPOINT,
      HTTP_METHOD.POST,
      args
    )
  ...
  postWithdrawRequestSocialSendMoney(args) {
    return makeRequest(
      '/Transfer/Request/Social/SendMoney',
      API_ENDPOINT,
      HTTP_METHOD.POST,
      args
    )
